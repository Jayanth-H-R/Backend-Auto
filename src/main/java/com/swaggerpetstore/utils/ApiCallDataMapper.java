...
public class ApiCallDataMapper {
  /**
   * This class is used to map the ApiCallData to the required DTOs.
   * It uses Jackson ObjectMapper to convert the JSON response/request body to the required DTO class.
   */
