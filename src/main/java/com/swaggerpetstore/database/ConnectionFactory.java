...
public class ConnectionFactory {
    ...
    /**
     *  Method to close all connections (called when done with DB operations)
     *  This method iterates through all connections stored in the ThreadLocal map
     *  This method we can use it in afterSuite Method to clean up the connection
