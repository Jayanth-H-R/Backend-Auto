...
public class BaseValidator {
	...
	public void verifySuccessStatusCode() {
		Assert.assertTrue(this.apiCallData.getResponse().statusCode() == 200, "Success Status code mismatch");
	}

	public void verifyBadRequestStatusCode() {
		Assert.assertTrue(this.apiCallData.getResponse().statusCode() == 400, "Bad request status code mismatch");
	}
}
