...
public class PetTestCase implements ILogger {
    ...
    /**
     * This method initializes the test data and the controller before running the tests.
     */
    @BeforeTest
    ...
    /**
     * This method adds a delay before each test to ensure that the environment is ready.
     * It can be useful in scenarios where the API might take some time to be ready for the next test.
     */
    @BeforeMethod
    ...
    public void testAddPet() {
        ...
        new AddPetValidator(apiCallData)
                .validateAddPet(apiCallData, apiCallDataMapper);
    ...
    public void testGetPetById() {
        ...
        new AddPetValidator(apiCallData)
                .validateGetPetById(apiCallData, apiCallDataMapper);
    ...
    public void testUpdatePetById() {
        ...
        new AddPetValidator(apiCallData)
                .validateUpdatePet(apiCallData, apiCallDataMapper);
    ...
    public void testDeletePetById() {
        ...
        new AddPetValidator(apiCallData)
                .validateDeletePet(apiCallData, apiCallDataMapper);
